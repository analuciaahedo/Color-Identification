...
class CVExample(Node):
    def __init__(self):
        ...
        self.lower = np.array([90, 50, 50])   # Valor inferior del rango de color HSV
        self.upper = np.array([150, 255, 255])  # Valor superior del rango de color HSV
    ...
    def timer_callback(self):
        try:
            if self.valid_img:
                ...
                self.pub.publish(self.bridge.cv2_to_imgmsg(mask))
        except:
