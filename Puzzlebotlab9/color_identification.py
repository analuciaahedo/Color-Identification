...
class CVExample(Node):
    ...
    def process_red_mask(self, red_mask):
        ...
        cv2.imshow("Image with Red Highlight", highlighted)
        cv2.waitKey(1)
    ...
    def process_blue_mask(self, blue_mask):
        ...
        cv2.imshow("Image with Blue Highlight", highlighted)
        cv2.waitKey(1)
    ...
    def process_green_mask(self, green_mask):
        ...
        cv2.imshow("Image with Green Highlight", highlighted)
        cv2.waitKey(1)
    ...
    def process_yellow_mask(self, yellow_mask):
        ...
        cv2.imshow("Yellow Detection Mask", yellow_mask)
        cv2.imshow("Image with Yellow Highlight", highlighted)
        cv2.waitKey(1)
    ...
    def process_white_mask(self, white_mask):
        ...
        cv2.imshow("Image with white Highlight", highlighted)
        cv2.waitKey(1)
    ...
    def calculate_and_publish_red_mass_center(self, red_mask):
         ...
         cv2.imshow("Red Detection Mask", red_mask)
         cv2.imshow("Image with Center of Mass", self.img)
         cv2.waitKey(1)
    ...
    def calculate_and_publish_white_mass_center(self, white_mask):
            ...
            cv2.imshow("WHhite Detection Mask", white_mask)
            cv2.imshow("Image with Center of Mass", self.img)
            cv2.waitKey(1)
